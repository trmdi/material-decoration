...
ApplicationMenuButton::ApplicationMenuButton(Decoration *decoration, QObject *parent)
    : CommonButton(KDecoration2::DecorationButtonType::ApplicationMenu, decoration, parent)
{
...
void ApplicationMenuButton::paintIcon(QPainter *painter, const QRectF &iconRect)
{
